    ...
    if (date.weekday == DateTime.saturday) {
      return const Center(
        child: Padding(
          ...
          child: Text(
              "Ob vegetarisch, vegan, mit Fleisch oder Fisch – bei uns findest du genau das, was du suchst. Genieße frische Salate, köstliche Desserts und leckere Kuchen. Für jeden Geschmack ist etwas dabei!"),
        ),
      );
    }
